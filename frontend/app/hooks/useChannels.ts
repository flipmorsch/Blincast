...
export function useChannels() {
  ...
  const fetchChannels = async () => {
    setLoading(true);
    try {
      const fetchUrl = onlyWithImage ? `${API_URL}/channel/with-image` : `${API_URL}/channel`;
  ...
  return { channels, loading, createChannel, updateChannel, deleteChannel, setOnlyWithImage };
}
